...
if pluginConfig.enabled then
    ...
    if pluginConfig.enableCommands then
        RegisterCommand("showid", function(source, args, rawCommand)
		    ...
		    local player = source
                    local name = ("%s %s"):format(players[player].firstName, players[player].lastName)
                    local dob = players[player].dob
                    char.img = "https://th.bing.com/th/id/R.74db127ae3b13fce5b6f646801743e39?rik=0yqppRDhXvIdyw&pid=ImgRaw&r=0"
